...
from src.Algoritimos.Aprendizagem_Baseada_Instancia_KNN.knn import Algoritimo_KNN


def avaliarKnn(todos_os_previsores: list, alvo: list, ):
    print('----------------------------------------------')
    ...
    for i in todos_os_previsores:
        ...
        response = Algoritimo_KNN(dados_treino_e_teste)
